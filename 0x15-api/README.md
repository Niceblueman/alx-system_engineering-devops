...
<ul>
<li><a href="/rltoken/KMFzqRAqedMf7AHHBD_43g" title="Friends don't let friends program in shell script" target="_blank">Friends don’t let friends program in shell script</a> </li>
...
<li>You must use <a href="/rltoken/CNqOWPW6mdYuK7Ak-f2KHQ" title="get" target="_blank">get</a> to access to dictionary value by key (it won’t throw an exception if the key doesn’t exist in the dictionary)</li>
